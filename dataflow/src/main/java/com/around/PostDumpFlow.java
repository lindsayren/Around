...
public class PostDumpFlow {
    ...
    private static final String PROJECT_ID = "circular-hawk-203921";
    private static final Charset UTF8_CHARSET = Charset.forName("UTF-8");


    public static void main(String[] args) {
        // Start by defining the options for the pipeline.
        //read a PCollection from a table, with an optional Scan
        ...
        CloudBigtableScanConfiguration config = new CloudBigtableScanConfiguration.Builder()
                ...
                .withInstanceId("aound-post")
                .withTableId("post")
                .build();

        PCollection<Result> btRows = p.apply(Read.from(CloudBigtableIO.read(config)));//一个pcollection
        //转化数据格式从Result变成TableRow
        //ou don't need to manually extract the elements from the input collection;
        // the Dataflow Java SDK handles extracting each element and passing it to your DoFn subclass.
        //. When you override processElement,
        // your override method must accept an object of type ProcessContext, which allows you to access the element that you want to process.
        // You access the element that's passed to your DoFn by using the method ProcessContext.element().
        ...
        //Relational DB 需要知道table schema
